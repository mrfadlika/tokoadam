...
<div class="card mb-3">
    ...
    <div class="table-responsive">
        <table>
            <thead><tr><th>Pelanggan</th><th class="text-center">Jml Transaksi</th><th class="text-right">Total Item</th><th class="text-right"><?= $isProductFiltered ? 'Nominal Produk' : 'Total Nominal' ?></th></tr></thead>
            <tbody>
